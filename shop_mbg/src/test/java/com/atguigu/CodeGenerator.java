...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("E:\\dianshang\\code\\shop_parent\\shop_core\\shop_seckill\\src\\main\\java");
        globalConfig.setAuthor("lijiaxin");
        //生成后是否打开资源管理器
        ...
        dataSourceConfig.setUrl("jdbc:mysql://192.168.147.128:3306/shop_seckill?serverTimezone=GMT%2B8");
